...
Line 166:3 Transforming let to the configured target environment ("es5") is not supported yet
Line 167:3 Transforming let to the configured target environment ("es5") is not supported yet
	...
	jQuery(function($){
		$(document.body).on('click', '.quick_view_btn', function(e) {
			...
			$.getJSON( $(this).attr( 'href' ) + '.js', function( product ) {
				...
				$.getScript( "//theme808-apparelix-watches.myshopify.com/cdn/shopifycloud/shopify/assets/themes_support/option_selection-86cdd286ddf3be7e25d68b9fc5965d7798a3ff6228ff79af67b3f4e41d6a34be.js", function() {
